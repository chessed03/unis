<div class="card card-default">
    ...
    <div class="card-header">
        ...
        <div class="row">
            ...
            <div class="col-6 text-right">
                ...
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#createModal"><i class="bx bx-fw bxs-plus-circle bx-xs"></i> Nuevo post </button>
    ...
    @include('livewire.system.posts.create')
    @include('livewire.system.posts.update')
