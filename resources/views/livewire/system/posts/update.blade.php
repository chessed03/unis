                ...
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="select2-info form-group" wire:ignore>
                                <select wire:model="schools" id="update-schools" data-model="schools" class="select2" data-dropdown-css-class="select2-success" multiple="multiple">
                        ...
                        <div wire:ignore class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <textarea class="form-control form-group" id="tiny-editor-update"></textarea>
                        </div>
...
@push('js')
    ...
    <script>
        let upload_image_update = '{{ route("post-upload-image") }}';

        let token_update        = '{{ csrf_token() }}';

        tinymce.init({
            height : "440",
            selector: 'textarea#tiny-editor-update',
            language: "es_MX",
            plugins: [
                'image code',
            ...
            images_upload_url: upload_image_update,
            ...
            images_upload_handler: function(blobInfo, success, failure) {
                ...
                xhr.open('POST', upload_image_update);

                xhr.setRequestHeader("X-CSRF-Token", token_update);
