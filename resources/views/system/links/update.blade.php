                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                ...
                                                <input type="text" name="platform_high_school_students_url" id="platform_high_school_students_url" class="form-control" value="{{ $item->platform_high_school_students_url }}">
                                            </div>
                                            
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="platform_high_school_teachers_url">URL plataforma de maestros - Nivel Preparatoria:</label>
                                                <input type="text" name="platform_high_school_teachers_url" id="platform_high_school_teachers_url" class="form-control" value="{{ $item->platform_high_school_teachers_url }}">
                                            </div>
                                            
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="platform_degree_students_url">URL plataforma de estudiantes - Nivel Licenciatura:</label>
                                                <input type="text" name="platform_degree_students_url" id="platform_degree_students_url" class="form-control" value="{{ $item->platform_degree_students_url }}">
                                            </div>
                                            
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="platform_degree_teachers_url">URL plataforma de maestros - Nivel Licenciatura:</label>
                                                <input type="text" name="platform_degree_teachers_url" id="platform_degree_teachers_url" class="form-control" value="{{ $item->platform_degree_teachers_url }}">
                                            </div>
