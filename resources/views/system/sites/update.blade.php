                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                ...
                                                <input type="text" name="primary_color" id="primary_color" class="form-control" value="{{ $item->primary_color }}">
                                            </div>

                                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 form-group">
                                                <label for="secondary_color">Color secundario:</label>
                                                <input type="text" name="secondary_color" id="secondary_color" class="form-control" value="{{ $item->secondary_color }}">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <span class="btn btn-primary btn-file elevation-2" onchange="uploadImage()" data-action="btn-upload" data-input-url="favicon_url" data-preview-image="favicon_preview">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <input class="form-control @error('favicon_url') is-invalid @enderror" name="favicon_url" readonly="readonly" id="favicon_url" type="text" value="{{ $item->favicon_url }}">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                                                ...
                                                <img
                                                    src="{{ $item->favicon_url ?? asset('template/admin/img/sitio/site-working-none.png') }}"
                                                    id="favicon_preview"
